...
- **[`docs/changelog.md`](docs/changelog.md)** — consolidated summary of report changes across review rounds. The "what changed since I last looked" entry point for a returning reviewer.
