...
- **The other documents own one thing each.** [`docs/style.md`](docs/style.md) owns the code's form; the README the layout and the commands; a design note its component's design (`docs/shell_design.md`, `docs/node_protocol.md`, `docs/code_distribution.md`, `docs/install.md`); [`shell/README.md`](shell/README.md) how the shell's code reads; [`docs/review.md`](docs/review.md) the review before a release; and [`docs/language_feedback.md`](docs/language_feedback.md) and [`docs/report_cold_read.md`](docs/report_cold_read.md) the questions still open.
