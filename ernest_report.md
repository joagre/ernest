...
Revision of 21 September 2026. Rationale, rejected alternatives, and open questions are in [`decisions.md`](docs/decisions.md).
...
type Event = Char(Char) | ArrowUp | ArrowDown | ArrowLeft | ArrowRight | Enter | Escape
