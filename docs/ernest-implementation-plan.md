...
- Built-in: `Int`, `Bool`, `String`, `Bytes`, `Char`, `()`, `List(a)`, `Map(k, v)`, `Optional(a)`, `Either(e, a)`. Structural `==` on all data values; `Int.compare` and `String.compare`, no universal ordering.
