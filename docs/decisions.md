...
**2026-09-26.** [The Last Types Named](#the-last-types-named-2026-09-26); [A Supervisor Is Told by Its Own Children](#a-supervisor-is-told-by-its-own-children-2026-09-26); [`Peer.find` Stands](#peerfind-stands-2026-09-26); [A TCP Peer Is TCP's](#a-tcp-peer-is-tcps-2026-09-26); [`trim` Is a Named Pair](#trim-is-a-named-pair-2026-09-26); [Everything About a Process in Its Module](#everything-about-a-process-in-its-module-2026-09-26); [One Question About a Process](#one-question-about-a-process-2026-09-26); [One Way to Fault](#one-way-to-fault-2026-09-26); [The System References Live in Their Modules](#the-system-references-live-in-their-modules-2026-09-26); [The Cold Read's Last Findings](#the-cold-reads-last-findings-2026-09-26); [A Precondition Is One Line](#a-precondition-is-one-line-2026-09-26); [One Subscription to the Terminal a Process](#one-subscription-to-the-terminal-a-process-2026-09-26); [A Function May Be Named `module_info`](#a-function-may-be-named-module_info-2026-09-26); [An Input's Number Is Given Again](#an-inputs-number-is-given-again-2026-09-26); [The Shell Lets Go of an Input](#the-shell-lets-go-of-an-input-2026-09-26); [A Process Is Watched From Its Start](#a-process-is-watched-from-its-start-2026-09-26); [Where the Toolchain's Modules Split](#where-the-toolchains-modules-split-2026-09-26); [One Copy of Each Scope Rule](#one-copy-of-each-scope-rule-2026-09-26); [What a Name Resolved To Is Recorded](#what-a-name-resolved-to-is-recorded-2026-09-26); [A Failure of the Runtime Shows Its Stack](#a-failure-of-the-runtime-shows-its-stack-2026-09-26); [A Gate Before the Build](#a-gate-before-the-build-2026-09-26); [Completion Reaches What the Session Knows](#completion-reaches-what-the-session-knows-2026-09-26); [The Path Rule Has One Owner](#the-path-rule-has-one-owner-2026-09-26); [A Word Is Readline's](#a-word-is-readlines-2026-09-26); [One Tool, the Job Its First Word](#one-tool-the-job-its-first-word-2026-09-26); [What the Library Lacked](#what-the-library-lacked-2026-09-26); [A Name Follows the Vocabulary](#a-name-follows-the-vocabulary-2026-09-26); [A Shim Reaches the Representation](#a-shim-reaches-the-representation-2026-09-26); [A Subscription Says Whether It Has Keys](#a-subscription-says-whether-it-has-keys-2026-09-26); [A Listener Says Its Port](#a-listener-says-its-port-2026-09-26); [A System Message Is Its Module's to Make](#a-system-message-is-its-modules-to-make-2026-09-26); [A Stream Keeps Its Own Time Limit](#a-stream-keeps-its-own-time-limit-2026-09-26); [Every Fault Is Delivered to Whoever Subscribes](#every-fault-is-delivered-to-whoever-subscribes-2026-09-26); [The Live Processes Are a Library Function](#the-live-processes-are-a-library-function-2026-09-26); [A Process's Identity Is a `Process`](#a-processs-identity-is-a-process-2026-09-26); [A `Supervisor` in the Standard Library, and `fault`](#a-supervisor-in-the-standard-library-and-fault-2026-09-26); [A Peer's Service Is Found Through Its Binding](#a-peers-service-is-found-through-its-binding-2026-09-26); [An Initializer Runs as a `Never` Process](#an-initializer-runs-as-a-never-process-2026-09-26); [Every Fault Reaches Standard Error](#every-fault-reaches-standard-error-2026-09-26); [A Restart Has a Limit and No Strategy](#a-restart-has-a-limit-and-no-strategy-2026-09-26); [A Call Ends When Its Callee Faults](#a-call-ends-when-its-callee-faults-2026-09-26); [Names, Restarts and Supervision](#names-restarts-and-supervision-2026-09-26); [A `Bool` Does Not Choose a Behaviour](#a-bool-does-not-choose-a-behaviour-2026-09-26); [One Contract, Several Representations](#one-contract-several-representations-2026-09-26); [A Foreign Type States the Equality It Needs](#a-foreign-type-states-the-equality-it-needs-2026-09-26); [A Redundant Clause Is an Error](#a-redundant-clause-is-an-error-2026-09-26); [A Pure Function Stands for One With a Mailbox](#a-pure-function-stands-for-one-with-a-mailbox-2026-09-26).

**2026-09-25.** [Libraries As They Are Wanted](#libraries-as-they-are-wanted-2026-09-25); [The Cold Read's Smaller Rules](#the-cold-reads-smaller-rules-2026-09-25); [An Initializer Depends on What It Names](#an-initializer-depends-on-what-it-names-2026-09-25); [`after` Stays Reserved](#after-stays-reserved-2026-09-25); [Constant Patterns Stay Out](#constant-patterns-stay-out-2026-09-25); [A Build of the Compiler Is Its Version and Its Code](#a-build-of-the-compiler-is-its-version-and-its-code-2026-09-25); [Not-Reply-Carrying by What the Body Does](#not-reply-carrying-by-what-the-body-does-2026-09-25); [A `match` Is an Operand](#a-match-is-an-operand-2026-09-25); [No Projection From a Tuple](#no-projection-from-a-tuple-2026-09-25); [Field Selection](#field-selection-2026-09-25); [Two Visibilities Are Enough](#two-visibilities-are-enough-2026-09-25); [A Later Input May Add a Member](#a-later-input-may-add-a-member-2026-09-25); [Names Stay Qualified, Without Import or Alias](#names-stay-qualified-without-import-or-alias-2026-09-25); [Constructor Names Stay Unique in a Module](#constructor-names-stay-unique-in-a-module-2026-09-25); [No OTP in the Toolchain](#no-otp-in-the-toolchain-2026-09-25); [The Report Read Cold, Its Plain Half](#the-report-read-cold-its-plain-half-2026-09-25); [An Abstract Type's Boundary Is Its Module](#an-abstract-types-boundary-is-its-module-2026-09-25); [The Code Read Back](#the-code-read-back-2026-09-25); [A Function Value Keeps Its Module's Version](#a-function-value-keeps-its-modules-version-2026-09-25); [A Refusal Is Red](#a-refusal-is-red-2026-09-25); [The Session's Names in Spawn Sites](#the-sessions-names-in-spawn-sites-2026-09-25); [`libs/markdown`, Written at Once](#libsmarkdown-written-at-once-2026-09-25); [Documentation Is Shown as CommonMark](#documentation-is-shown-as-commonmark-2026-09-25); [Every Name `:doc` Completes Has Documentation](#every-name-doc-completes-has-documentation-2026-09-25); [A Command's Argument, and the Commands' Order](#a-commands-argument-and-the-commands-order-2026-09-25); [What `Tab` Shows Stands Under the Line](#what-tab-shows-stands-under-the-line-2026-09-25).

**2026-09-24.** [The Closing Sweep of the Shell](#the-closing-sweep-of-the-shell-2026-09-24); [Typing Ahead](#typing-ahead-2026-09-24); [Colour, Built](#colour-built-2026-09-24); [The Keys Tested at a Terminal](#the-keys-tested-at-a-terminal-2026-09-24); [Tests That Wait on Events, and Colour Where It Means Something](#tests-that-wait-on-events-and-colour-where-it-means-something-2026-09-24); [The Signature Inside a Call](#the-signature-inside-a-call-2026-09-24); [Test Areas Built](#test-areas-built-2026-09-24); [One Name Prints Its Declared Type](#one-name-prints-its-declared-type-2026-09-24); [Test Areas](#test-areas-2026-09-24); [The Prelude Documented](#the-prelude-documented-2026-09-24); [The Plan, the README, and the Architecture Note Brought Level](#the-plan-the-readme-and-the-architecture-note-brought-level-2026-09-24); [The Guide Read Cold](#the-guide-read-cold-2026-09-24); [MVP 2.61's Closing Sweep](#mvp-261s-closing-sweep-2026-09-24); [The Guide's Tools Page and Its Word to the Erlang Programmer](#the-guides-tools-page-and-its-word-to-the-erlang-programmer-2026-09-24); [The Guide Shows a Supervisor](#the-guide-shows-a-supervisor-2026-09-24); [The Guide's Running Example](#the-guides-running-example-2026-09-24); [An Erlang Module of One's Own, and the Prelude's Documentation](#an-erlang-module-of-ones-own-and-the-preludes-documentation-2026-09-24); [The Guide's Fragments Are Checked](#the-guides-fragments-are-checked-2026-09-24); [The Guide Teaches Failure in One Place](#the-guide-teaches-failure-in-one-place-2026-09-24); [The Guide's First Sections Cut to Teaching Weight](#the-guides-first-sections-cut-to-teaching-weight-2026-09-24); [The Guide Opens With What the Compiler Finds](#the-guide-opens-with-what-the-compiler-finds-2026-09-24); [The Guide's Examples Are Checked](#the-guides-examples-are-checked-2026-09-24); [§6.6 Reads Top-Down](#66-reads-top-down-2026-09-24); [The Report Read Again After the Day's Changes](#the-report-read-again-after-the-days-changes-2026-09-24); [`a<-1` Is Named](#a-1-is-named-2026-09-24); [An Alarm Carries the Time It Fired](#an-alarm-carries-the-time-it-fired-2026-09-24); [`with` Keeps Its Two Uses](#with-keeps-its-two-uses-2026-09-24); [A Typed Character Is `Key(c)`](#a-typed-character-is-keyc-2026-09-24); [An Input That Reads a Line Faults, as §11.2 Said](#an-input-that-reads-a-line-faults-as-112-said-2026-09-24); [E.0 Rule 2 States Its Constraint](#e0-rule-2-states-its-constraint-2026-09-24); [Two Cryptic Sentences](#two-cryptic-sentences-2026-09-24); [Two Rules Move to Where They Are Looked For](#two-rules-move-to-where-they-are-looked-for-2026-09-24); [§3.9 and E.0 Rule 6 Split](#39-and-e0-rule-6-split-2026-09-24); [§8.2 and §11.2 Split Into Headed Paragraphs](#82-and-112-split-into-headed-paragraphs-2026-09-24); [`Float.pow` Is Partial in Its Type](#floatpow-is-partial-in-its-type-2026-09-24); [What Makes a Type the Prelude's](#what-makes-a-type-the-preludes-2026-09-24); [Three Failures Principle 3 Answers For](#three-failures-principle-3-answers-for-2026-09-24); [A `String` Counts Graphemes, and Says So](#a-string-counts-graphemes-and-says-so-2026-09-24); [`bits` and `native` Leave the Bit Syntax](#bits-and-native-leave-the-bit-syntax-2026-09-24); [`Erl.Result` Goes](#erlresult-goes-2026-09-24); [One Primitive for Remote Computation](#one-primitive-for-remote-computation-2026-09-24); [A Type's Identity on the Wire Is Nominal](#a-types-identity-on-the-wire-is-nominal-2026-09-24); [A Time Below 0 Is 0](#a-time-below-0-is-0-2026-09-24); [Parentheses After a Pipe Make a Value](#parentheses-after-a-pipe-make-a-value-2026-09-24); [The Shell's Reload Ends a Process, It Never Changes One](#the-shells-reload-ends-a-process-it-never-changes-one-2026-09-24); [`Prelude` Names the Prelude](#prelude-names-the-prelude-2026-09-24); [`remote` Catches Nothing](#remote-catches-nothing-2026-09-24); [A Fault Is a Death With `Fault`, and a Deadlock Is One](#a-fault-is-a-death-with-fault-and-a-deadlock-is-one-2026-09-24); [Ets Is a Library](#ets-is-a-library-2026-09-24); [A Statement Is Unit](#a-statement-is-unit-2026-09-24).

**2026-09-23.** [The Emacs Mode Was Settled by Measurement](#the-emacs-mode-was-settled-by-measurement-2026-09-23).

**2026-09-21.** [The Region Is a Pure Function](#the-region-is-a-pure-function-2026-09-21); [A Tab Is Painted, Not Written](#a-tab-is-painted-not-written-2026-09-21); [A Paste Is One Event](#a-paste-is-one-event-2026-09-21); [An Input That Spans Lines](#an-input-that-spans-lines-2026-09-21); [Two Races the Shell's Startup Found](#two-races-the-shells-startup-found-2026-09-21); [The History, and Walking It](#the-history-and-walking-it-2026-09-21); [Where `foreign` Stops](#where-foreign-stops-2026-09-21); [The Editor Is Its Own Module](#the-editor-is-its-own-module-2026-09-21); [What the Live Region Cost to Build](#what-the-live-region-cost-to-build-2026-09-21); [One Event, and the Page Keys Go](#one-event-and-the-page-keys-go-2026-09-21); [The Panes Become a Live Region](#the-panes-become-a-live-region-2026-09-21).

**2026-09-20.** [Two Panes, Painted by the Shell](#two-panes-painted-by-the-shell-2026-09-20); [The Terminal Module, and `io_ansi` Measured Again](#the-terminal-module-and-ioansi-measured-again-2026-09-20); [The Startup Inputs, Two Files](#the-startup-inputs-two-files-2026-09-20); [A Test Waits for the Screen](#a-test-waits-for-the-screen-2026-09-20); [A `let` Is a Value, Whatever Its Type](#a-let-is-a-value-whatever-its-type-2026-09-20); [Loading and Reloading a Module](#loading-and-reloading-a-module-2026-09-20); [Every Fault Is Reported](#every-fault-is-reported-2026-09-20); [Two Panes, and One Module for the Terminal](#two-panes-and-one-module-for-the-terminal-2026-09-20); [OTP 29, and Why the Terminal Stays Ours](#otp-29-and-why-the-terminal-stays-ours-2026-09-20); [A File Beside the Prompt](#a-file-beside-the-prompt-2026-09-20); [The Commands That Need No New Door](#the-commands-that-need-no-new-door-2026-09-20); [Declarations at the Prompt](#declarations-at-the-prompt-2026-09-20); [A Binding That Holds a Function](#a-binding-that-holds-a-function-2026-09-20); [Programming on Purpose](#programming-on-purpose-2026-09-20); [Checkpoint 0 on a Terminal](#checkpoint-0-on-a-terminal-2026-09-20); [Checkpoint 0, in Line Mode](#checkpoint-0-in-line-mode-2026-09-20); [The Spike: How an Input Sees the Session](#the-spike-how-an-input-sees-the-session-2026-09-20); [A Terminal for the Tests](#a-terminal-for-the-tests-2026-09-20); [The Shell's Smaller Rules](#the-shells-smaller-rules-2026-09-20); [The Shell Alone, and MVP 3 in Halves](#the-shell-alone-and-mvp-3-in-halves-2026-09-20); [The Shell and the Stack Are Two Milestones](#the-shell-and-the-stack-are-two-milestones-2026-09-20); [One Proxy in Front of an Address](#one-proxy-in-front-of-an-address-2026-09-20); [Every Monitor Is the Reaper's](#every-monitor-is-the-reapers-2026-09-20); [MVP 2.5 Closed](#mvp-25-closed-2026-09-20); [`via` Is a Value](#via-is-a-value-2026-09-20); [What Can Still Deliver](#what-can-still-deliver-2026-09-20); [The Terminal Reads Keys Again](#the-terminal-reads-keys-again-2026-09-20); [The Shell Reports a Fault](#the-shell-reports-a-fault-2026-09-20); [A Signal Says Nothing](#a-signal-says-nothing-2026-09-20); [Running the Paper Programs](#running-the-paper-programs-2026-09-20); [An Entry's Path Is the Path You Read](#an-entrys-path-is-the-path-you-read-2026-09-20); [Documentation in the Compiled Module](#documentation-in-the-compiled-module-2026-09-20); [One Token for the Project](#one-token-for-the-project-2026-09-20); [The Sweep After Step 4](#the-sweep-after-step-4-2026-09-20); [`Ets` in the Standard Library](#ets-in-the-standard-library-2026-09-20); [`Tcp`, Measured, and the Refusals Gone](#tcp-measured-and-the-refusals-gone-2026-09-20); [`Keys`, and Who Owns the Terminal](#keys-and-who-owns-the-terminal-2026-09-20); [`Fs` in Ernest](#fs-in-ernest-2026-09-20); [`Sys.stdin` and `Io.readLine`](#sysstdin-and-ioreadline-2026-09-20); [The Sync Sweep After Step 3](#the-sync-sweep-after-step-3-2026-09-20); [`Clock` in Ernest, and Step 3 Finished](#clock-in-ernest-and-step-3-finished-2026-09-20); [The Corpus Decisions, Re-judged](#the-corpus-decisions-re-judged-2026-09-20); [`Io` in Ernest, and `Sys.stderr` Restored](#io-in-ernest-and-sysstderr-restored-2026-09-20); [`Random` in Ernest](#random-in-ernest-2026-09-20); [`Foreign` in Ernest, and `Foreign.from`](#foreign-in-ernest-and-foreignfrom-2026-09-20); [`Path` in Ernest](#path-in-ernest-2026-09-20); [Shims Where the Runtime Owns the Representation](#shims-where-the-runtime-owns-the-representation-2026-09-20); [`Map` and `Set` in Ernest](#map-and-set-in-ernest-2026-09-20); [Prefix `!`](#prefix--2026-09-20); [`String` in Ernest](#string-in-ernest-2026-09-20); [`Float`'s Boundary](#floats-boundary-2026-09-20); [Nothing Waits for a Program](#nothing-waits-for-a-program-2026-09-20); [`Bytes` Has a Module](#bytes-has-a-module-2026-09-20); [`List` in Ernest](#list-in-ernest-2026-09-20); [The Standard Library's Root Builds Into `build/stdlib`](#the-standard-librarys-root-builds-into-buildstdlib-2026-09-20).

**2026-09-19.** [Rule 6 Matched to the Agreed Template](#rule-6-matched-to-the-agreed-template-2026-09-19); [No Negative Zero](#no-negative-zero-2026-09-19); [Digit Separators](#digit-separators-2026-09-19); [`Io.debug` Prints by Type](#iodebug-prints-by-type-2026-09-19); [The Shims Rule Names Every Conversion](#the-shims-rule-names-every-conversion-2026-09-19); [Integer Literals in Every Common Base](#integer-literals-in-every-common-base-2026-09-19); [A Built-in Type's Operators in Its Module](#a-built-in-types-operators-in-its-module-2026-09-19); [A Standard Library File Is Compiled With Its Own Root](#a-standard-library-file-is-compiled-with-its-own-root-2026-09-19); [No Not-Reply-Carrying Mark on a Container Element](#no-not-reply-carrying-mark-on-a-container-element-2026-09-19); [`Io.debug`, and String Interpolation Considered](#iodebug-and-string-interpolation-considered-2026-09-19); [Abstract-Type Ownership](#abstract-type-ownership-2026-09-19); [Documentation Before the Standard Library](#documentation-before-the-standard-library-2026-09-19); [Reply-Carrying Lambdas](#reply-carrying-lambdas-2026-09-19); [Deadlock Is Quiescence](#deadlock-is-quiescence-2026-09-19); [The Shell in Ernest](#the-shell-in-ernest-2026-09-19); [The Compiler's Version in the Build Record](#the-compilers-version-in-the-build-record-2026-09-19); [MVP 2.7, the Fetcher, and No Server](#mvp-27-the-fetcher-and-no-server-2026-09-19); [Raw Strings, and No Regex Literals](#raw-strings-and-no-regex-literals-2026-09-19); [The Shell's Design](#the-shells-design-2026-09-19); [Documentation Inside the Compiled Module](#documentation-inside-the-compiled-module-2026-09-19); [The Test Type and the Standard Library's Layout](#the-test-type-and-the-standard-librarys-layout-2026-09-19); [Bool's Read-Back](#bools-read-back-2026-09-19); [Tests, `Erl`, and `Ets` Moved](#tests-erl-and-ets-moved-2026-09-19); [The Standard Library in the Build Record](#the-standard-library-in-the-build-record-2026-09-19); [`Optional` and `Either` in Ernest](#optional-and-either-in-ernest-2026-09-19); [The First Module in Ernest](#the-first-module-in-ernest-2026-09-19); [Pattern Alternatives](#pattern-alternatives-2026-09-19); [The Paring Read Back](#the-paring-read-back-2026-09-19); [Nine Points from the Consistency Pass](#nine-points-from-the-consistency-pass-2026-09-19); [Operator Members Checked on Demand](#operator-members-checked-on-demand-2026-09-19); [The Message Check Moves to the Point of Exposure](#the-message-check-moves-to-the-point-of-exposure-2026-09-19); [Receive Guards Are Guard Expressions](#receive-guards-are-guard-expressions-2026-09-19).

**2026-09-18.** [Bitstrings](#bitstrings-2026-09-18); [The Foreign Boundary](#the-foreign-boundary-2026-09-18); [Operators Resolved in Inference](#operators-resolved-in-inference-2026-09-18); [Auditing MVP 2](#auditing-mvp-2-2026-09-18); [Type Error Placement](#type-error-placement-2026-09-18); [Diagnostics](#diagnostics-2026-09-18); [What the Reply Check Guarantees](#what-the-reply-check-guarantees-2026-09-18); [Paring the Report](#paring-the-report-2026-09-18); [The Final Pass](#the-final-pass-2026-09-18); [Fs by Its Structure, and the Table](#fs-by-its-structure-and-the-table-2026-09-18); [Path by Its Structure](#path-by-its-structure-2026-09-18); [Gleam's Standard Library, Compared](#gleams-standard-library-compared-2026-09-18); [The Erlang Standard Library, Read for Ernest](#the-erlang-standard-library-read-for-ernest-2026-09-18); [System Modules](#system-modules-2026-09-18); [Appendix E: Read Back Against Its Own Rules](#appendix-e-read-back-against-its-own-rules-2026-09-18); [Appendix E: Admission and Shape Rules](#appendix-e-admission-and-shape-rules-2026-09-18); [Appendix E: Three Rules and a Consistency Pass](#appendix-e-three-rules-and-a-consistency-pass-2026-09-18).

**2026-09-17.** [Type Variables Keep Their Names](#type-variables-keep-their-names-2026-09-17); [Types Print as the Module Writes Them](#types-print-as-the-module-writes-them-2026-09-17); [`--doc` Prints Types](#--doc-prints-types-2026-09-17); [One-Word Module Names](#one-word-module-names-2026-09-17); [Module Names and the Parser Loop](#module-names-and-the-parser-loop-2026-09-17); [Three Sentences From the Toolchain Audit](#three-sentences-from-the-toolchain-audit-2026-09-17); [Long Options and `--emit erl`](#long-options-and---emit-erl-2026-09-17); [Acyclic Modules and Interface-Based Recompilation](#acyclic-modules-and-interface-based-recompilation-2026-09-17); [`Down`'s `function` Field and the Already-Dead Reason](#downs-function-field-and-the-already-dead-reason-2026-09-17); [Warts Audit](#warts-audit-2026-09-17); [Five Sentences From the First Implementation](#five-sentences-from-the-first-implementation-2026-09-17); [Report Read-Through Fixes](#report-read-through-fixes-2026-09-17); [`Void` → `Unit`](#void--unit-2026-09-17).

**2026-09-16.** [Lowercase Load-Path Segments](#lowercase-load-path-segments-2026-09-16); [`ernc` Directory Mode; Output Dir Auto-Creation; Path-Shape Rejection](#ernc-directory-mode-output-dir-auto-creation-path-shape-rejection-2026-09-16); [`export` Keyword; Declarations Use Local Names](#export-keyword-declarations-use-local-names-2026-09-16); [`main` De-Specialization; Source Root; No More "Root Namespace"](#main-de-specialization-source-root-no-more-root-namespace-2026-09-16); [`ernc` Directory-Mode Cleans Stale `.erc` Outputs](#ernc-directory-mode-cleans-stale-erc-outputs-2026-09-16); [Sixth-Round Review Response: Type-Member Ownership, Concrete Operators, Path Rules](#sixth-round-review-response-type-member-ownership-concrete-operators-path-rules-2026-09-16).

**2026-09-15.** [Ping-Pong Example: Main Must Wait For Workers](#ping-pong-example-main-must-wait-for-workers-2026-09-15); [Deadlock Detection Distinguishes Idle Server From Deadlocked Program](#deadlock-detection-distinguishes-idle-server-from-deadlocked-program-2026-09-15); [Code Shipping: Dependency, Type-Version, and Runtime-Binding Contracts](#code-shipping-dependency-type-version-and-runtime-binding-contracts-2026-09-15); [Appendix D (ETS) Fixes: Syntax Sweep and Native Type](#appendix-d-ets-fixes-syntax-sweep-and-native-type-2026-09-15); [Reply Ownership Extends to Reply-Carrying Types](#reply-ownership-extends-to-reply-carrying-types-2026-09-15); [Effect-Variable Kinds: One Kind, Position Controls Admissibility](#effect-variable-kinds-one-kind-position-controls-admissibility-2026-09-15); [Block Bindings: Escape Path and Wildcard Rule](#block-bindings-escape-path-and-wildcard-rule-2026-09-15); [Equality Constraints Propagate Through Values, Branches, and Modules](#equality-constraints-propagate-through-values-branches-and-modules-2026-09-15); [Float Semantics: Minimal Reparation, Reject the Bloat](#float-semantics-minimal-reparation-reject-the-bloat-2026-09-15); [Content Hashing: Recursive Groups and Abstract-Type Boundaries](#content-hashing-recursive-groups-and-abstract-type-boundaries-2026-09-15); [Code Shipping Boundaries: Transport, Failure Channels, Runtime Bindings](#code-shipping-boundaries-transport-failure-channels-runtime-bindings-2026-09-15); [Bitstring `bits` Segments Must Be Byte-Aligned When Binding to `Bytes`](#bitstring-bits-segments-must-be-byte-aligned-when-binding-to-bytes-2026-09-15); [Fault List and Initialization: Extend §7.4, Acknowledge Partial Init](#fault-list-and-initialization-extend-74-acknowledge-partial-init-2026-09-15); [Function-Type Grouping: `ParenType` Overrides Nearest-Arrow](#function-type-grouping-parentype-overrides-nearest-arrow-2026-09-15); [Guards and Bitstring Size Expressions: Pure, No Fault Swallow](#guards-and-bitstring-size-expressions-pure-no-fault-swallow-2026-09-15); [Distributed Failure: One Simple Model, Loss Is Terminal](#distributed-failure-one-simple-model-loss-is-terminal-2026-09-15); [Modules: Nested Namespace Ownership and Cross-Module Type Info](#modules-nested-namespace-ownership-and-cross-module-type-info-2026-09-15); [Grammar: Negative Numeric Patterns and Lambda-After-Pipe Parens](#grammar-negative-numeric-patterns-and-lambda-after-pipe-parens-2026-09-15); [Effect Variables: Primitives Are Non-Empty (U01 Soundness Fix)](#effect-variables-primitives-are-non-empty-u01-soundness-fix-2026-09-15); [Four "Partly Resolved" Tails: Blocks, Reply Timing, Termination, Deadlock Scope](#four-partly-resolved-tails-blocks-reply-timing-termination-deadlock-scope-2026-09-15); [Third-Round Review Response: Float Finite-Only, ABI Table, Restriction Propagation, Assorted Repairs](#third-round-review-response-float-finite-only-abi-table-restriction-propagation-assorted-repairs-2026-09-15); [Mint-Condition Audit: Grammar Notes, Main Default, Guide Sync](#mint-condition-audit-grammar-notes-main-default-guide-sync-2026-09-15); [Fourth-Round Review Response: Canonical Field Order, Injective Tags, Function-Value Init, Underflow](#fourth-round-review-response-canonical-field-order-injective-tags-function-value-init-underflow-2026-09-15); [Fifth-Round Cleanup: Function Hash Preserves Eval Order, Underflow Threshold, Sqrt Removal](#fifth-round-cleanup-function-hash-preserves-eval-order-underflow-threshold-sqrt-removal-2026-09-15); [Guide Rewrite: Crash-Course Structure, All UG Corrections, Upgrade Example](#guide-rewrite-crash-course-structure-all-ug-corrections-upgrade-example-2026-09-15); [Guide Round 2: Targeted Corrections, Runnable Checkpoints, Coverage Gaps](#guide-round-2-targeted-corrections-runnable-checkpoints-coverage-gaps-2026-09-15); [Guide Round 3: Example Repairs, Setup Concreteness, Small Wording](#guide-round-3-example-repairs-setup-concreteness-small-wording-2026-09-15); [Reply Timeout Semantics: Late Answers and Mailbox Isolation](#reply-timeout-semantics-late-answers-and-mailbox-isolation-2026-09-15); [`Bytes` and Bitstring Alignment](#bytes-and-bitstring-alignment-2026-09-15); [Numeric Semantics and Fault Rules](#numeric-semantics-and-fault-rules-2026-09-15); [Top-Level Initialization Specified](#top-level-initialization-specified-2026-09-15); [Polymorphic Empty Values and Monomorphic `let`](#polymorphic-empty-values-and-monomorphic-let-2026-09-15); [Annotations Describe Shape](#annotations-describe-shape-2026-09-15); [Equality Policy for Polymorphic Types](#equality-policy-for-polymorphic-types-2026-09-15); [`Reply` Ownership Made Compositional](#reply-ownership-made-compositional-2026-09-15); [Effect Polymorphism Specified](#effect-polymorphism-specified-2026-09-15); [`remote` Is Not Pure](#remote-is-not-pure-2026-09-15); [`()` → `Void`](#void-2026-09-15); [`Text` → `String`](#text--string-2026-09-15); [Tuples: `#(...)` Prefix](#tuples--prefix-2026-09-15); [`opaque` → `abstract`](#opaque--abstract-2026-09-15); [`recv` → `receive`](#recv--receive-2026-09-15); [Section 2 Tightening](#section-2-tightening-2026-09-15); [List and Concat Operators](#list-and-concat-operators-2026-09-15); [Terminology Sweep](#terminology-sweep-2026-09-15); [Section 0 Rewrite](#section-0-rewrite-2026-09-15); [`Set(a)` Restored](#seta-restored-2026-09-15).

**2026-09-14.** [Gleam Feature Pass](#gleam-feature-pass-2026-09-14); [Bit Operators as Stdlib Functions](#bit-operators-as-stdlib-functions-2026-09-14); [`Bool.ern` Added](#boolern-added-2026-09-14); [Against OTP as a Language Feature](#against-otp-as-a-language-feature-2026-09-14); [`Set(a)` Removed From the Prelude](#seta-removed-from-the-prelude-2026-09-14); [`Sys.stderr`, `Io.eprint`, `Io.eprintln` Removed](#sysstderr-ioeprint-ioeprintln-removed-2026-09-14); [Bit Arrays in the Report, MVP 2 in the Plan](#bit-arrays-in-the-report-mvp-2-in-the-plan-2026-09-14); [Pipe Operator `|>`](#pipe-operator--2026-09-14); [Against Labeled Function Arguments](#against-labeled-function-arguments-2026-09-14); [`Address.callForever` in the Prelude](#addresscallforever-in-the-prelude-2026-09-14); [`parallelRemote` in the Prelude](#parallelremote-in-the-prelude-2026-09-14); [Standard Library Baseline](#standard-library-baseline-2026-09-14); [Ambient Sys, Five Principles](#ambient-sys-five-principles-2026-09-14).

**2026-09-13.** [Three Layers](#three-layers-2026-09-13); [Packages](#packages-2026-09-13); [Tests](#tests-2026-09-13); [Remote Ergonomics](#remote-ergonomics-2026-09-13); [No Registry](#no-registry-2026-09-13); [Backpressure](#backpressure-2026-09-13); [Request-Reply](#request-reply-2026-09-13); [Against Gleam](#against-gleam-2026-09-13); [`as`](#as-2026-09-13); [Patterns](#patterns-2026-09-13); [Colliding Words](#colliding-words-2026-09-13); [The Word](#the-word-2026-09-13); [MVP Split](#mvp-split-2026-09-13); [Review](#review-2026-09-13); [FFI](#ffi-2026-09-13); [Distribution](#distribution-2026-09-13).

**2026-09-12.** [Grammar Audit](#grammar-audit-2026-09-12); [Syntax Revision 3](#syntax-revision-3-2026-09-12).
...
- No canonical supervisor. Programs by different authors will structure supervision differently. *Revisited 2026-09-26 by "Names, Restarts and Supervision": a restart that keeps the address may enter the language, and a supervisor the standard library.* The three-uses rule will likely surface a `Supervisor.ern` in the stdlib once a few paper programs write the shape; that is fine, but it will not be baked into the language.
...
## The Guide Opens With What the Compiler Finds, 2026-09-24

The guide's reader has not read the report and needs a reason to go on. A list of features gives none, and a comparison with other languages boasts. Four mistakes of a concurrent program with `ernc`'s error beside each give a reason the reader can check: a message the process does not take, a reply left unanswered, a pure function that prints, and a failure dropped by a statement. They are the four rules that make Ernest what it is, and each error is the compiler's own text, checked by the test, so the page cannot claim more than the compiler does. After them the guide names what Ernest took and from where: processes, faults as messages, and code replacement from the Erlang runtime; inference, `fn`, `|>`, `..` update, and foreign types from Gleam; content addressing from Unison. Then it names what Ernest adds, the mailbox in the function's type, checked replies, purity in the type, and distribution by content on the Erlang runtime. The report names no other language, by its form; the guide does, because a reader weighs a claim by what it is measured against, and crediting the sources is what makes the claim of the rest credible rather than boastful. The claims are kept to what is true: Gleam already types messages, on its channels, so what is Ernest's is the mailbox in the function's type, not typed messaging on the runtime. Distribution is described as §8.7 states it and marked planned, since the toolchain runs one node until MVP 3.0. §1.2 says what the shell does at a terminal, completion by position and abbreviation, documentation at the cursor, history search, and the live region, since a newcomer tries the language there first. The guide is retitled *Programming in Ernest*, since it teaches writing and not reading. Hello world runs with no configuration, so `ern --create-config-dir` moves to §7, the first place a program needs a peer. The shell is in §1, because it is where a newcomer tries a line. A console after a rejected block is compared with the error, and a console of `ern --shell` is replayed as a session, with its `> ` lines as the inputs.
...
## The Guide's Fragments Are Checked, 2026-09-24

A fragment in the guide was code that nothing compiled: it named what a block above defined, or what no block defined, and the output it claimed was a comment. Each became what it was trying to be. An expression is a shell session, which the test replays, so what the guide says the value is, the shell printed, and a reader can type it back; the shell was taught in §1, so using it in §2 is teaching it again. A declaration is a complete module, and a program with output has its console. A signature is `:type`, the compiler's own printing of it, so the guide cannot drift from the prelude. Blocks that name one file are its parts in order, which is how §4.6 builds its program in three steps, and a console may give `ern` its options, which is how §7.1 shows `ern --test`.
...
## MVP 2.61's Closing Sweep, 2026-09-24

Two readings, as the working rules ask at the end of a plan step, each by a reader who had not written the text. The guide against the report found fifteen: the worst was §8 written in the present tense for peers the toolchain does not yet have, so the guide now says at §8's head what one node does meanwhile, and the `remote` example shows the output it gives today, which the test checks; the rest were a paper program's tests misreported, bare citations meant for the report, and rules stated narrower than the report states them, the delimiters of a lambda's body, the ways to settle a block `let`'s type, the irrefutable patterns, the process-only functions. Every other document against the report and the code found fifteen more: example headers citing the guide by numbers the renumbering had moved, which the citation check cannot see since the old numbers still exist; the shell design note behind today's §11.2; the plan still listing the guide's shell chapter and idioms as owed; the architecture note's account of the tests seven kinds behind; and four places the MVP 3 notes disagree with the report that the plan had not listed, which it now does, to be decided before those milestones build on them. A citation check that confirms a number exists does not confirm it still names what the sentence means; the renumberings of this milestone were four, and the headers were the place that showed it.

## The Guide Read Cold, 2026-09-24
...
`Shift-Tab` inside an unfinished call shows the callee's signature with the argument at the cursor marked. The parser was already the only thing that knew what the cursor stood in, and it told completion through the diagnostic's `expected`; the call is told the same way, in a field of its own, since inside an argument the parser also expects an expression and completion still needs to hear it. The innermost call names itself, because the error it catches first is its own. The mark was first asterisks around the parameter, the emphasis of the markdown the shell's pages are written in, and became the terminal's cyan the same day: the hint is read at a glance beside the cursor, which is where a terminal uses colour, a colour takes no column where asterisks change the text, and `Shift-Tab` exists only at a terminal, so colour is always there to be had. The palette's cyan rather than a fixed colour, so that the theme makes it readable on a dark screen and a light one. The front end gives the signature in three parts and the shell paints the middle one, since the terminal is the shell's and not the checker's; and the live region, which measures rows by their characters, learned that an escape sequence takes no column and that a row cut short must reset its colour. Blanket `catch _:_` in the new front-end functions had hidden a defect while this was written, a match on an already bound name; they and an older one in `:doc` became explicit cases, so that a defect shows as a crash rather than as a missing answer. A prelude primitive has no declared parameter names, so its signature shows types alone rather than invented names. The brief on a name ends with the version it appeared in, which rule 6 gives every declaration, its own `since` or its module's; the page leaves out a module's `since` on each declaration, so the shell adds it.

## Tests That Wait on Events, and Colour Where It Means Something, 2026-09-24

The program session had asserted on faults that a 400 ms wait was meant to have let happen, and under load it once did not. A wait on the clock is a guess about the machine; a wait on the event is not. The worker the session spawns could be monitored from the prompt, but the program's own entry point could not, since no input holds its address and there is no registry to find it by (§6.5), so the wait moved into the harness, which already waits for text on the screen: the session runs in the pseudo-terminal and waits for each fault report and each answer. Writing it reproduced the typing-ahead defect found on 2026-09-21, an input typed while another runs losing its result, which now has a reproduction in the plan. Timing the area showed that its cost had not been those waits at all but one session that waited out the harness's thirty-second timeout, since `C-d` leaves only on an empty line and it ended with an input on the line.
...
## The Closing Sweep of the Shell, 2026-09-24

Two readers who had not written the text read the guide against the report and every other document against the report and the code, and one of them ran the shell while reading. They found four defects in the toolchain, which no test had found, since no test had done what a person trying the guide's examples does.

A timed `receive` as the first input of a session in line mode was a deadlock. The reaper started a process and then wrote its row, so a process whose first act was a timed receive counted itself into a row not yet there, and the row it got said it waited untimed. The shell's first input met the race every time, and a program could meet it too. The process now starts once its row is written. The same run showed that §11.2's rule, no deadlock while a shell holds the terminal, had never been built: at a terminal the reader's subscription is a source and hid the gap, and in line mode nothing did. The detector now asks whether a shell holds the terminal, which is the rule as §11.2 states it.

`let h = fn() = Io.println("x")` at the prompt entered the session with its effect variable free, and the next input's check crashed on it. The shell's test of whether an input settles its bindings' types left effect variables out, on the argument that an effect variable is ordinary polymorphism and settles nothing about a value. §11.2 says a `let` at the prompt is a block `let`, and §3.9 makes an unresolved effect variable an error at a block binding, which `ernc` already reported. The shell now uses the block's test, and the help line names the other way to settle a function, declaring it with `fn`, which generalizes. Generalizing the prompt's `let` instead was weighed and refused: it would make the prompt's `let` a top-level one, which §11.2 says it is not, and a second meaning of `let` at the prompt.

A declared name printed as one name after other inputs could print through a later input's substitution, since a scheme's variables were named inside the current type state, where the same number may be bound to something else. A scheme's variables are its own, and the state's substitution no longer reaches them. Printing a type also elides an effect variable that occurs once and is not process-only, which generalization replaces with pure; §11.5 said only that a variable bound to pure is elided, and now says this too.

The shell's `:doc` painted a page's first line red, since the colour commit sent the page through the function that colours a diagnostic. The start line wrote the version by hand, and now reads `VERSION`. A session at a terminal without `HOME` kept no history and said nothing, which the design note had promised it would say; §11.2 now says it, and the shell does.
...
Three findings of the session of real use about commands. `:browse` and `Tab` did nothing, since the word was whole and there was nothing to add; `:browse ` and `Tab` indented, since no word stood before the cursor; and `:browse Li` offered constructors, since the argument completed as an expression, where `:browse` takes a module. Each is a surprise by principle 1. A whole command that takes an argument now takes its space, as a shell completes a unique word; the argument completes from what the command takes, which its help line already names; and `Tab` never indents after a command, where four spaces mean nothing. The closing sweep had left `:set`'s words out so as not to promise a second vocabulary; with one rule for every argument they are no second vocabulary, only what `:set` takes.

`:load`'s modules are under the source root and not yet loaded, so the front end cannot answer them. They are read from the source root in Ernest, with `Fs.list`, which is beneath the shell, a directory at a time: the one the finished segments of the word name. A walk of the whole root would read a home directory on every `Tab` when the shell is started there. A directory is offered when its name keeps §11.1's path shape, whether or not it holds a module, since knowing would take a walk.

A module offered after `:browse` or `:load` is listed by its name alone. The listing in an expression says `module List` to tell a module from the values beside it; where every candidate is a module the word says nothing. A lone candidate is listed too, so that `Tab` on a whole name shows its type and on a whole command its help line, where it had shown nothing: a key that changes nothing and says nothing is the surprise the rule of the finding before this one removed.

The commands were listed in an order chosen by use, and §11.2 made that order decide an ambiguous prefix, `:b` being `:browse` and `:f` `:forget`. A reader of `:help` could not see that the order meant anything, and expected alphabetical order. Principle 3 asks for the rule to be visible, and principle 1 for the order a reader predicts: the commands are listed alphabetically, and a prefix that begins more than one name is refused with the names it begins. Only `:b` and `:f` were ambiguous, and each costs one letter more. The 2026-09-21 argument that the prefix order must be the whole order from the start has nothing left to hold: no order decides a prefix now.

## Every Name `:doc` Completes Has Documentation, 2026-09-25

A finding of the session of real use: `:doc Ac` completed to `:doc Accept`, which answered that there was no documentation for it. Reading on found the same answer for every constructor, for a module, and for a `let` at the prompt, a session declaration headed `Input1.sz`, and `:doc` finding nothing in a module `:load` had compiled. Completion offering a name that `:doc` then refuses is the surprise principle 1 names, and each has a place in §11.4's page already. A constructor is documented in its type's section, so its documentation is its type's, as GHCi's `:info` answers a constructor with its data type. A module's is the head of its page, the title, version, and doc block; the whole page would list what the module declares, which is `:browse`'s job, and one answer for one job is principle 2. A session declaration's entry is written under the input's namespace and its type under the input's names, which §11.2's scope does not show anywhere else, so its heading is the name as the session writes it and its type the one the shell prints. A `let` at the prompt declares nothing and has no entry, and its name and type are what §11.4 would write for a declaration without a doc block. A module `:load` compiled is loaded from memory, and the front end looked for its file; the session holds its compiled form, which is now read first. The narrower alternative, completing after `:doc` only names that have a page, was refused: it would leave `:doc Some` unanswered at the prompt, where a reader asks it.
...
## `libs/markdown`, Written at Once, 2026-09-25

The ruling of the morning left the shell's pages as CommonMark until a renderer existed, and named one as what would reopen it. The cost of the ruling is paid at every `:doc`, and the renderer is a small library, so it was written the same day rather than waiting for MVP 2.8. It reads what doc blocks hold, the blocks and inlines of CommonMark 0.31, and keeps as written what it does not read, so a page is never half rendered by a rule the library does not state: its doc block names each simplification. Without styles, inline markup stays as written, since plain text has no other way to show emphasis or code; with them, each style is turned off by its own code rather than a reset, so a style inside another leaves the outer on. The shell ships the compiled library beside its own modules, as a program carries the libraries it was compiled against; the tier rule, that a library is on no load path unless a program puts it there, holds, since the shell is the program putting it there. The morning's entry keeps its argument against a partial renderer, which this library answers by being whole for what doc blocks contain.

## The Session's Names in Spawn Sites, 2026-09-25

A finding of the session of real use: `:processes` showed a process spawned at the prompt as `Input2.main:1`. The design note had chosen that, the input's module being a real module; but the session writes its names unqualified (§11.2) and its diagnostics name an input as the file `input`, so `Input2` and `main` were names a person meets nowhere else, and `2` counted inputs the prompt never numbers. A site is now written as the session writes names: `input:1` in an input's own expression, the line within the input, and `start:1` in a function the session declared. Two processes spawned by two inputs then read alike; numbering inputs, as GHCi's `<interactive>:3` does, would put on screen a count the session shows nowhere else, which principle 3 does not ask for, and an address with an identity is a question of its own. `Input<n>` stays visible in one place, a type a later declaration of its name has shadowed, where two types printing alike would be worse. Reading the wrapper found a defect: it was `export fn main`, and since §11.2's scope looks in the input's own declarations first, `main()` after `fn main` at the prompt called the wrapper forever. It is named `'$input'`, which the lexer cannot produce, so it shadows nothing, and the emitter recognises a site inside it without being told.

## A Refusal Is Red, 2026-09-25

A finding of the session of real use: `:load hhhh` answered in red and `:set depth a` in the terminal's own colour, both being refusals, since `:load`'s went through the function that colours a compiler diagnostic and the rest through the one that does not. Colour carries meaning (the 2026-09-24 entry *Colour, Built*): a fault or an error needs the eye. So the rule is by meaning, what the shell refuses is red and what it answers is plain, and `no source has changed` is plain as `the session declares nothing yet` is, being answers. The same session showed `:reload hhhh` answered as if the argument were not there; the working rules forbid accepting input silently, so a command that takes nothing refuses an argument, in red as any refusal.
...
## The Report Read Cold, Its Plain Half, 2026-09-25

A reader who had never seen Ernest read the report alone as its implementer and found 79 places where it did not suffice (`docs/report_cold_read.md`). Each was checked against the implementation. Where the rest of the report implied one reading, the implementation already followed it, and no principle argued the other way, the report now states it, and a test holds it where none did; that is about three quarters of them, written the same day. They add no rule of their own: they say what an implementer would otherwise have had to guess, which is Wirth's measure of a report. What remains open is in the findings file, under the themes of MVP 2.65.

**Where the plain reading changed the code.** Five times the report now states what the code did not yet do, since the code had accepted something the reading refuses or crashed where it should have answered. A bitstring specifier that means nothing for its segment, `float-signed` or `utf8-little`, is a type error rather than silently ignored. `ern` refuses an entry point that is a `let` or a function of another shape, where it ran `fn main() -> Int` and exited 0. A float literal beyond the largest finite `Float` is an error at the literal, where the lexer crashed. A signature's type variables reach a block `let`'s annotation, as they reach a lambda's; they did not, so `let y : a = 1` in a `fn` over `a` was accepted. And a time has no upper bound, where one above 2^32 − 1 milliseconds faulted with the host's text. Named constructor fields are evaluated in source order, which §3.5 already said and the emitter did not do. Writing the tests found two defects more, fixed: a type variable inside a `Map`'s key, `Map(#(k, Int), v)`, took no equality constraint, and two local `fn`s of one name in a block were accepted when a statement stood between them. The runtime's tests found two more: a module loaded on its first call left its caller waiting on the host's code server, which the deadlock rule read as blocked, so a program faulted with `deadlock` in most runs of a timed call followed by `Io.debug`; the load is now counted as the host's work, as a foreign call is (§8.6). And a `Clock.alarm` beyond the host's longest timer killed the clock, so every later alarm was lost; the clock sets such an alarm again in slices, as a timed receive now waits.

**What it left in the plan.** A function value that foreign code returns is checked when it is called (§7.4), which the boundary does not yet do; the fix is the address proxy's shape, and it is a standing gap with the step that builds it.

## No OTP in the Toolchain, 2026-09-25

No process of the toolchain's own is an OTP behaviour, no `gen_server`, `supervisor` or `application`, and the toolchain is built by `make` rather than rebar3. It is a design choice, not an omission, and three arguments carry it. The rule is about processes: a callback module that one of OTP's own servers calls, such as a handler of the signal server, runs no loop of ours and is not what it refuses.

**The runtime is the report's process model, written directly.** `ern_rt` starts every process of a program, records how each ends, and decides by §8.6's rule when none can progress: the system processes, the reaper and the launcher are plain `receive` loops whose waiting and whose pending sources of messages that rule reads. An OTP server wraps its loop, its calls and its failures in machinery of its own, which the runtime would then have to see through to say what §8.6 says, and whose restart and exit semantics are a second model of failure beside §6.9's.

**The toolchain is written as Ernest asks programs to be written.** The language refuses OTP's behaviours as constructs (*Against OTP as a Language Feature*): a server, a supervisor and a timeout are a few lines over `spawn`, `monitor` and `receive`, visible where they are used. The runtime that carries those programs keeps the same discipline, so that what the report promises is what a reader of `ern_rt` finds.

**It is a compiler and a runner.** `ernc` and `ern` start, work and end on the command line; there is no long-running service to supervise, no release to assemble, and no hot upgrade that OTP's machinery would serve. `make` builds each application with `+debug_info -Werror`, and the one borrowed library, `getopt`, is vendored.
...
## A Later Input May Add a Member, 2026-09-25
...
## A `match` Is an Operand, 2026-09-25
...
## Constant Patterns Stay Out, 2026-09-25

Feedback item 3, weighed and left as it is: an identifier in a pattern binds, so `let ctrlW = '\u{17}'` cannot stand in a `match` arm, and Readline's key table is literals with a comment beside each. A pattern that compares against a constant needs a rule saying which identifiers bind and which compare; Rust's is by case and scope, Elixir's the pin `^`. Either makes a pattern's meaning depend on what is in scope, which the pattern does not show (principle 3), and the pin is a second spelling of a guard (principle 2). The guard, `c when c == ctrlW`, says the comparison where it happens. What would change it: a program whose tables of constants read wrongly as literals and as guards alike.

## `after` Stays Reserved, 2026-09-25

Feedback item 5, weighed and left as it is: `after` is the keyword of `receive`'s time limit (§6.3), and scanning code in the shell and in `libs/markdown` wanted it as a name, and wrote `from` and `later`. A keyword valid as an identifier outside `receive` would make the token's meaning depend on where it stands (principle 4), and the names that replaced it read as well. What would change it: a second keyword that the same kind of code keeps wanting, which would say that the reserved words are chosen badly as a set.

## An Initializer Depends on What It Names, 2026-09-25

Feedback item 48 and the cold read's 1.13. §8.5 orders the top-level `let`s by what they reference "directly or through the functions it calls", and the implementation counted a name mentioned, called or not, so `libs/markdown`'s `let starts = [headingStart, ...]`, whose functions reach back to `starts`, was a cycle. Counting only what an initializer calls while it runs would accept that list, and would accept `let a = fn() = a()` and `let handlers = [f]` with `f` reading `handlers`, where nothing stops the list from being passed to code that calls `f` before `handlers` has a value; knowing what runs during initialization is undecidable in general. The mention rule was kept and stated in §8.5, with a lambda's body counted as part of its initializer. The library's `fn starts()` is the answer, and it reads as what it is.

## The Cold Read's Smaller Rules, 2026-09-25

Seven findings of the cold read, each with one reading once checked against the implementation.

The order of evaluation (1.2, §5.1): a callee is evaluated before its arguments, and in `x |> e`, `x` before `e`. The implementation evaluated a computed callee of a pipe before `x`, since the pipe becomes a call with `x` first among the arguments. Source order is what a reader reads (principle 3), and a pipe is a way of writing an argument first.

`..` on a type with several constructors (1.6, §5.6): a type error. The value given may have been built by another constructor, and the implementation then faulted with the host's `badmatch`; a fault §7.4 does not list, or a check that follows the flow, were the alternatives. Every `..` in the repository is on a type with one constructor.

A type argument as a value position (2.6, §3.9): only where the type's fields put its parameter in a value position, so `type H(e) = H(f : (Int) -> Unit with e)` may hold a pure callback. A built-in or foreign type's argument is a value position, since its fields are not seen. §6.6 follows the same fields, so such a type is reply-carrying only where a field is, and `H(Request)` is not.

A member's shape (2.8, §4.8): an operator member is `(T, T) -> R`, `compare` `(T, T) -> Ordering`, `negate` `(T) -> R`, each pure. Resolution by operand type (§4.8) and the orderings of §3.10 assume these shapes, and a member of another shape was accepted and misbehaved at its use, far from the mistake.

A local `fn` beside a variable of its name (2.9, §5.4): an error. The checker took the `fn` and the emitter the other binding, and the program faulted with the host's `badfun`. Shadowing a variable with a function, visible throughout its block, would make the order of the block's statements decide which a name means (principle 3).

A receive guard (2.17, §6.3): its grammar written out, with a `Bool` operand, `!`, `true`, `false` and a negative literal. `when !flag` was refused and `when !flag == true` accepted, a second way forced by an omission (principle 2); a negative literal is a constant, not a call to `negate`.

A local `fn`'s signature (2.34, §3.9): it shares the enclosing signature's variables, as a lambda's and a block `let`'s annotation do, so `a` means one type throughout a definition. A variable new to it is the local function's own and generalized with it, as a local `fn` is.

## Libraries As They Are Wanted, 2026-09-25

The libraries not yet written, `json`, `base64`, `tls`, `http`, `regex`, `crypto`, `uri` and `zlib`, left MVP 2.7 and 2.8 for one milestone after content addressing, and each is written when our work needs it, when someone asks for it, or when we want it. This reverses the entry of 2026-09-19 that planned four of them without a program, whose argument, that executed examples are a library's first user, still holds for how one is written, not for when. The language is still moving, and the day's field selection, abstract boundary and reply rule each sent a sweep through every line of Ernest in the repository: a library written now is code every later decision must carry. What the milestones were for is done otherwise: Appendix D's pattern has been written twice, a shim in `libs/ets` and pure Ernest in `libs/markdown`, and the compiler's second real user was the shell. CLAUDE.md's rule that a feature is not deferred until a program asks is about the language; a library is neither the language nor its standard library but what anyone writes on Appendix D's pattern, and writing one when it is wanted is how that tier is meant to grow; CLAUDE.md now says so. What stays in MVP 2.7 is not a library: `Sys.args`, `Sys.env` and an exit status, which every program started from a shell wants, and the appendix listing the two libraries that exist.

## A Pure Function Stands for One With a Mailbox, 2026-09-26
...
## A Foreign Type States the Equality It Needs, 2026-09-26

Feedback item 39. The equality constraint of §3.10 is inferred from a body, and a `foreign type`'s operations have none in Ernest, so `Ets.Table((Int) -> Int, v)` type-checked and `ets` compared the keys by the host's term equality, the comparison §3.10 refuses on functions and addresses. `Map` and `Set` had the constraint only because the checker named them. Three places could state it. None, as before, leaves the hole and the special case (principle 3). On each `foreign fn`'s variable, `key : k=`, reads as §11.5 prints, but repeats the mark in every signature of the type, where one missed reopens the hole, and invites the mark on ordinary functions, a second way beside inference (principle 2). On the foreign type's parameter, `foreign type Table(k=, v)`, says it once, of the type, which is what §3.10 already said of `Map(k, v)`; the prelude now declares `Map(k=, v)` and `Set(a=)`, and the checker reads the mark from the declaration instead of from two names (principle 5). The type is enough because a shim exists only where the host owns the representation (E.0 rule 1): what the host compares is a foreign or built-in type's content, and a `foreign fn` comparing a bare variable would be doing work Ernest can write. The mark is refused on an ordinary type's parameter, whose operations are Ernest and whose constraint inference finds.

## One Contract, Several Representations, 2026-09-26

Feedback item 52, weighed and left as it is: Ernest has no interface, signature or type class, and one contract over several representations is a record of functions, which the guide's §7.3 teaches in two forms: values that carry their operations, a record whose functions close over the value's data, which is what a Java interface is mostly used for and lets one list hold circles and squares; and operations passed beside the data, with a set kept in a hash and one kept sorted, for code written once that must keep the representation's type, to take two values of it, as a union does, which the first form cannot, or to give one back that the representation's module still reads. What asked for more was a pure data structure written once and run over either representation, as Erlang's `sets` and `gb_sets` are by their shared names. The record does it with nothing added: the types check it where it is built, the generic code sees only the record, the caller chooses at the call, and what a representation needs, a `compare`, goes in as an argument. Field selection and a pure function standing for one with a mailbox, both decided the day before, made it read well: `operations.has(seen, x)`, `add = Set.put`. ML's signatures and functors would add a module language beside the value language (principle 5), and type classes choose the implementation by a type the call does not show (principle 3). What it does not give is a check that a module provides every name a contract lists. What would change it: a check-only contract, a declaration that a module provides `Sets.Operations`, verified by the compiler and adding no second way to call a function and no dispatch the call does not show; that is the one addition that could fit the principles, and it waits for a design. The names are spelt out, `Operations` and `operations()`, since a reader who knows the library expects words and not `ops`, and `operations` is a function even where it takes nothing, so that two representations read alike.

## A `Bool` Does Not Choose a Behaviour, 2026-09-26
...
*No Registry* (2026-09-13) left two things to every program: threading a service's address from `main` to every function that sends to it, and, once services restart, a supervisor that is also a name service, since a restarted child has a new address and whoever held the old one must be sent it. Each program writes the same forwarding and the same threading, a little differently. That is the churn *Ambient Sys, Five Principles* removed for the runtime's own processes: `Sys.stdout` is a named, typed address that nobody hands on, and it is visible because its name is at the use site. A program cannot declare one of its own. Against principle 2 the hand-written variants are many ways to do one job, and against principle 1 a reader must read each to know which variant it is.

The knot is Erlang's identity model, kept when Erlang's registry was refused: an address names one execution of a function, so a restart makes a new address, and a name bridges the gap. The cousins were surveyed on this day. Outside the BEAM, a restart keeps the reference: Akka Typed and Pekko restart a behaviour inside the same actor, its mailbox kept and the message being handled lost; Proto.Actor, Ray and Spritely Goblins keep it too; Orleans and Akka's sharding keep a logical key instead. Every BEAM language documents the gap between a death and a registration again: a call exits with `noproc` in Erlang, `send` panics in Gleam, and Elixir's `Registry` may return a process already dead. Where names survive, they are typed: Akka's `ServiceKey[T]`, Swift's reception keys, Gleam's `Name(message)` since its 1.0 of 2025, whose documentation gives the threading as its reason, and Unison's `ServiceName a b`. The registries keyed by strings, Erlang's, Lunatic's, Cloud Haskell's and Ray's, return the type the caller asserts. The capability literature, Miller's *Robust Composition* above all, refuses a mutable global namespace and admits a fixed top-level binding that designates something. Akka Typed moved supervision from the parent to a wrapper the child declares, stopping by default, since a parent's verdict cost a round trip and restart loops went unnoticed; Orleans has no supervision and is criticised for grains that run on with inconsistent state. A restart limit is universal; strategies across siblings are the BEAM's alone.

The direction. A process spawned through `restarting(f)` keeps its address and its mailbox across a fault and runs `f` again from its start; a fault is not catchable (§7.3), so the wrapper is the runtime's, and `spawn` stays one. A service is a top-level binding, `export let service : Address(M) = spawn(Local, restarting(...))`: typed by its declaration, reached by its name as `Sys.stdout` is (principle 3), and granted by `export`, so the capability discipline holds with module visibility as the permission. Nothing re-registers, since the address never changes. What `restarting` leaves out, a group of children, strategies across them and the order they stop in, is a library's, and whether the standard library has one is weighed again against E.0 rule 3, since every program would otherwise write it. The cost is one prelude function and one revoked rule, §4.6's pure initializer (principle 5).
...
Delivering the lost message again was refused: a message that faulted the process usually faults it again, so the process loops to its restart limit, and it would rescue the current message and not the replies held in the state. Akka and Proto.Actor refuse it for the first reason. Leaving it as it was, Akka's `ask` timing out, was refused on principle 3.
...
The second question *Names, Restarts and Supervision* left. A restart guarantees a known initial state, not a retry: a fault in the start itself, a missing file or a port in use, comes back at every restart, and without a limit the process spins, and floods whatever reports its faults. Every system surveyed has one: OTP one restart in five seconds by default, Elixir three, Gleam two, Akka `withLimit`, Proto.Actor a count in a window, Ray `max_restarts` at zero. A limit the runtime chose would be a policy the program cannot see (principle 3) and a choice made for it, which E.0 rule 3 refuses in the library; so the limit is written in the call, with no default, since it is part of what the process means. It is a constructor, `Limit(restarts = 3, within = 5000)`, and not two `Int`s, for the reason E.0 rule 9 gives against a `Bool`: the call says what it means only to a reader who knows the signature. Past the limit the process dies with the last fault's cause, so the loop becomes a death its monitors see and the first question's rule ends its calls.

Only a fault restarts. `Returned` is the function choosing to stop; `Killed` must stop a restarting process, or nothing could; `ProgramEnd` ends everything. That is OTP's transient child; its permanent child, restarted after a return too, would be a second behaviour of one wrapper (principle 2).

No strategy: `one_for_all` and `rest_for_one` are relations among siblings, and a wrapper around one function has none to see. Akka Typed's per-child supervision has none either, a group's failure reaching its parent through `watch`. No backoff: it is policy, it matters for outside resources, and a function that needs it waits at its own start. Both are the group's, the sixth question's `Supervisor`. Processes spawned before a fault run on, since nothing owns a process (§6.9), and the address they hold still reaches the restarted one.

## Every Fault Reaches Standard Error, 2026-09-26

The third question *Names, Restarts and Supervision* left, and feedback item 9. A program run by `ern` printed a fault only when it was the entry process's own (§11.2): a worker that divided by zero ended in silence, `main` finished, and the exit status was 0. The shell, under §11.2, prints every fault. A process that restarts never dies, so even a monitor would not see its faults, and a service could fault and restart under its limit for weeks with nothing said; restart loops that went unnoticed are what Akka Typed's stop-by-default answered. Principle 3 wants failure visible, and a fault nobody monitored was visible nowhere.

Taken: `ern` prints every fault of every process to standard error, in the shell's form, the spawn site and the cause, with `restarted` after a fault the limit allowed. Erlang's runtime logs every abnormal exit, monitored or not, and `ern` and the shell stop differing without a stated reason. A program that lets workers fault on purpose, the guide's job runner, prints a line for each: a fault expected is still a fault, and it goes to standard error, not to the program's output. A system process's fault and the shell's own are not printed, as §11.2 already says.

`monitor` stays one message, at death (§6.9). A restart is not a death, and a second kind of message would give `monitor` two jobs (principle 2). A program learns of a restarting process's faults from the report and of its end from the final death. A `Supervisor` that restarts a group, the sixth question's, restarts its children as new processes and sees each fault as a death, so it needs nothing here.

## An Initializer Runs as a `Never` Process, 2026-09-26

The fourth question *Names, Restarts and Supervision* left. A service binding needs `spawn` in an initializer, and §4.6 said the initializer is pure and effectful setup belongs in `main`. Admitting `spawn` alone would need a rule the types cannot state, since `spawn` and `Io.println` have one effect, `with m`; it would be a syntactic special case (principles 4 and 5). Taken instead: an initializer is checked as a body of mailbox type `Never`, which §6.8 already defines, so it may spawn, send and call and may not receive, and it runs in the entry process before `main`. An initializer may now print; two that do print in no promised order, as §8.5 already leaves independent initializers, and as two processes do.

The mention rule of §8.5, kept by item 48, needs nothing new: a binding depends on what its initializer names, lambda bodies included, so what a spawned service names was evaluated before it, and the process may start at once. Two services whose functions name each other are a cycle and a compile-time error, as `let a = fn() = a()` is. That is kept: the usual shape does not cycle, a service answering through the `Reply` it was given rather than by name, and the rare case uses the start message *No Registry* teaches; exempting a spawned body from the rule would put a special case into the rule item 48 kept simple.

A module is initialized whole, as §8.5 says, so a name used from a module starts the services it declares; a library that does not want that puts its service in a module of its own. A service one per node is shared by every test, which is the complaint about named singletons in Elixir, answered there by passing the name in; here by a pair, `fn start()` and `let service = start()`, the program using the binding and a test calling `start` for an instance of its own. §8.7 already evaluates a binding shipped code names on the peer, once per node, and the shell's reload already leaves a process on the version it runs; each gains a sentence where it meets a service.

## A Peer's Service Is Found Through Its Binding, 2026-09-26

The fifth question *Names, Restarts and Supervision* left, and the node protocol note's open question 8: a service that another node's own `main` started could not be reached, since spawning on the node only makes new processes and a spawned helper had no way to find the service there. With a service as a top-level binding it has one. §8.7 evaluates a binding that shipped code names on the peer, once per node for each hash of its definition, and an address sent in a message names the process it named where it was made; so a process spawned on the peer reads the binding and sends the address back. The two candidates the direction had left to MVP 3.0, a typed lookup table checked by the type hash and no discovery with one root node, are not needed: no table, no string, nothing new in the language, and the capability discipline holds, since a node names only what a module exports and only a configured peer spawns.

§8.7 gains two sentences. A node's own initialization is the evaluation shipped code reads, which "at most once per node" implies and does not say. And shipped code compiled from a different definition names a different binding, so the peer evaluates it on first use and starts a second service running the sender's version; that is sound, since talking to the peer's service of another version is what the type hash exists to refuse, but it is easy to miss, and principle 3 wants it stated and taught.
...
E.0 admits a function by one of four rules, and rule 3 is the one that can admit this: a general operation whose definition is the obvious one and in which no policy is buried. A supervisor is almost all policy, but none of it need be buried: the strategy, the group's limit and each child's are arguments without defaults, and the definition is the one OTP settled and every BEAM library copies, Gleam's among them, start in order, stop in reverse, three strategies. Rule 3 gains a sentence, that a policy the program passes as an argument is not buried. *Against OTP as a Language Feature* named no canonical supervisor as a cost; that cost is paid, and the supervisor is still a library's, not the language's.

How it restarts a group decided whether it fits the direction. Children as new processes behind forwarders need nothing from the language, but put back the knot the direction untied, inside the library: a hop on every message, and a supervised child's mailbox lost where a `restarting` one's is kept, two restarts that behave differently (principle 1). Taken instead: its children are `restarting` processes, and for a group strategy the supervisor restarts a sibling in place, its address and mailbox kept. Only the host can restart another process, so that is a shim internal to the module by the `foreign` rule, and the language gains no `restart(address)` that any holder of an address could call. The supervisor learns that a child restarted from a notice the module's wrapper sends at every start, a second from one child meaning a fault, in Ernest; `monitor` keeps its one job. `Supervisor.spawn` returns the child's typed address, and the supervisor holds its children as functions whose message types it does not see, the first form of the guide's §7.3, so children of any types share one supervisor. With service bindings the tree is a set of top-level bindings, started in dependency order. `RestForOne` means the children spawned after, and two independent children have no order and no reason to use it against each other.
...
Feedback item 26. The shell's `:processes` called a foreign function of its own, `ern_shell:processes/0`, which answered formatted lines: the shell saw what no program could, through a door in its own Erlang (principle 3), and the shim sat in one program where the `foreign` rule puts it in the standard library, since the list lives in the runtime. The entry's objections assumed a list of addresses: that enumerating would reach processes never handed over, against the capability discipline, and that the element type would need every mailbox type. A list of `Process` values, the identity of *A Process's Identity Is a `Process`*, grants nothing and needs no mailbox type.
...
Feedback item 28. The shell had two more doors into its Erlang front end: `watchDeaths`, a `Died(Down)` for every death in the runtime, from which it printed a line for each fault, and `faults()`, the last hundred faults kept by the host for `:faults`. §11.2 called it the runtime's record, read by the shell and not by a program. The entry's own point, that the session already receives every fault and can keep the hundred itself in Ernest, stands by the `foreign` rule: the list is shell state. The larger point is that after *The Live Processes Are a Library Function* the death stream is the same kind of door `processes()` was (principle 3), and that *Every Fault Reaches Standard Error* changed what it must carry: a fault after which a process restarts is not a death, so the stream needed is of faults.

Taken: `Process.faults(wrap)` in `stdlib/process.ern` delivers `wrap(r)` to the caller for every fault of every process the runtime started, with `type FaultReport = FaultReport(process : Process, site : String, cause : String, restarted : Bool)`, on E.0 rule 8's pattern for a function that delivers later, and for as long as the subscriber lives, as `Terminal.subscribe` does. It grants nothing, since a `Process` cannot be sent to. It is not a second `monitor`: that is one death of one process one holds, this every fault in the runtime, for diagnostics (principle 2), and a supervisor still monitors its children. `restarted` is a field, not an argument that chooses a behaviour, so E.0 rule 9 does not reach it. `ern`'s report of every fault to standard error is the runtime's own subscriber, and §11.2 says so. The shell subscribes, prints, and keeps its hundred in its state; `watchDeaths` and `faults()` go, and with `processes()` gone too the shell has no door of its own to the runtime's processes. The simple log MVP 2.7 is to decide can be a process in Ernest that subscribes and appends to a file.

## A Stream Keeps Its Own Time Limit, 2026-09-26

Feedback item 50. `Tcp.read(sock, 100)` was `Address.call` with a `Recv` carrying a reply; after the timeout the `Recv` stayed among the socket process's waiting replies, since §6.6 lets no recipient observe that its caller gave up, so the next bytes went to the dead reply and were discarded, and the next read got the bytes after them. `Tcp.accept` had the same shape and worse: the worker left waiting accepted the next connection for nobody, a connection open and unread, and a server that polled `accept` leaked a worker for every timeout. `Tcp.connect` leaked a connection that completed late. A time limit the caller keeps is right for a reply and wrong for a request whose answer takes something from a stream: the side that owns the data must decide whether time ran out, or both sides believe they have it.

Taken: the milliseconds travel in the request, and the signatures of E.18 stay. The socket process answers `Left(Timeout)` itself, the one process deciding whether bytes came first, and what comes later waits in its buffer for the next read; the accept and the connect use the host's own time limit, so a timeout takes no connection; the Ernest side waits with `Address.callForever`, since the system process always answers. E.18 gains that a read, accept or connect that times out has taken nothing. Offering no timed read on a stream was the other way, and it would send every program to `monitor` and `kill` for what one argument says.

The first question of *Names, Restarts and Supervision* had left a gap this met: a `callForever` caller is faulted "with the same cause" when its callee faults, and a callee killed, or returned without answering, has no cause to pass on. It faults the caller with `Fault("callee was killed")` or `Fault("callee returned without answering")`; a callee that ended with the program gives nothing, since the caller ends with it; `Address.call` answers `None` at once in every case.

## A System Message Is Its Module's to Make, 2026-09-26

Feedback item 47. `send(sock, Close)` stood beside `Tcp.close`, and every system message type of §9.7 had public constructors, so a program could send to `Sys.fs` or `Sys.clock` what their modules send: a second way to do each module's work (principle 2), and a way to break its contract, more so once *A Stream Keeps Its Own Time Limit* put a time limit into `Recv` that only `Tcp.read` should set. E.0 rule 8 said a system reference is used through its module and never by `send`, and nothing held a program to it; §9 already said a program does not send these types. No program, example or guide page did.

An abstract type (§4.4) is the tool, but these types are the prelude's by E.0 rule 7, and their system modules are above the prelude: moving the types into the modules would have `Sys.tcp`'s type in the prelude name a type of a standard library module. Taken: the prelude keeps the types, and each system module owns their constructors. The message types of the system references and of the addresses their modules answer, `StdinMsg`, `TerminalMsg`, `ClockMsg`, `FsMsg`, `TcpMsg`, `ListenerMsg` and `SockMsg`, have constructors that only their system module names; another module that names one is refused, and the error names the function to call. It is §4.4's boundary with its owner named by the report rather than by the file, and a program that cannot make a system message can neither send one nor adapt an address into one; the address itself is still passed, monitored, killed and identified. The checker keeps the table of owners, and a test holds it equal to §9.7.
...
Feedback items 11, 13, 42 and 46, the standard library's first batch, and 34 with them. E.0 rule 1 drew the shim line by ownership, where the runtime owns the representation its operations are the runtime's, which read literally is every operation of `Map`, `Set` and `String`; the `foreign` rule admits a shim only where Ernest cannot express the work given the layers beneath it, and `Map.filter` is expressible given `Map.toList` and `Map.put`. Where the two differ the report is corrected. Rule 1 now says that the operations that reach a representation the runtime owns are the runtime's, a small set each module's section names, and the rest are Ernest over them. The primitives pass data out and never call back into Ernest, so that the host never calls an Ernest function and effect polymorphism does not cross the boundary: `toList`, not `foldLeft`. Performance was not weighed, as the rule says.

`Map` and `Set` keep six shims each, from sixteen and fourteen; E.3 and E.4 leave the order of `toList` and `foldLeft` unspecified, so no contract moves. `String` keeps `indexOf`, `lastIndexOf`, `part` and `size`, which count grapheme clusters, its Unicode operations and its conversions; `startsWith`, `endsWith`, `contains`, `parts`, `copy` and `replace` become Ernest over them. That decides item 34: `split` and `endsWith` matched bytes where `contains` matched graphemes, so `split("e\u{301}", "e")` found an `e` that `contains` did not, and written over `indexOf` every search matches whole graphemes, which E.5 now says. `Bytes` keeps `size` and `part`, the bit syntax being beneath `at`, `toList` and `pack`. `Path` keeps the host's separator and `isAbsolute`, a root being an absolute path's first segment; `join`, `split`, `name`, `extension` and `withExtension` are Ernest over `String`, with tests of the trailing separator, the absolute second operand and the empty extension E.14 names.

`Random` is SplitMix64 in Ernest over `Int`'s bit operations, `Seed` an abstract type of `random.ern`: its three shims go, a seed is no longer a foreign value and so crosses nodes, and E.13 promises the same sequence everywhere, a promise that means something only with the algorithm named, so E.13 names it. `Path` stays transparent: an invariant such as no trailing separator would need it abstract, against the prelude's `FsMsg` that carries it and a `fromString` whose name item 40 has not settled, and each function handles those cases by its contract, the defects `Path.parent` fell through being answered by tests rather than a type (principle 5). `Markdown`'s `Block` and `Inline` stay transparent, since a caller matches on them, and a socket stays an address, since `monitor` and `kill` are why it is one. CLAUDE.md's sentence on a representation the runtime owns now says the same as rule 1.

## A Name Follows the Vocabulary, 2026-09-26

Feedback items 40, 41 and 38, the standard library's second batch. E.0's third shape rule put a conversion in the subject's module, yet `String.fromList`, `Map.fromList`, `Set.fromList` and `Either.fromOptional` live in their result's. Moving them would give `List.toMap` and `Optional.toEither`, the most basic module naming every container built on it, a dependency turned over; the functions are right and the rule said too little. It now says that between a type and one its module builds on both directions are the building module's, `fromX` and `toX`, and otherwise each direction is its argument's module's `toX`, as `Int.toString` and `String.toInt`; and so a conversion exists once (principle 2).

`Set.intersect` was a verb beside the nouns `union` and `difference`; it becomes `intersection`, the name in Erlang's `sets`, Gleam, Haskell and Elixir (principle 1), with no alias. `String.contains` stays a substring test: membership of one grapheme is the case of a substring one grapheme long, one operation, and every language a reader comes from means the substring by it; the second shape rule says so of text.
...
Admitted. `Map.mergeWith(m, other, f)`, `f` taking the two values as Gleam's `dict.combine` does, by rule 3, a general operation with the obvious definition, and not refused by rule 4, being a fold over `update` rather than a pipe of two functions; the key Erlang also passes is rarely wanted (principle 5), and `Map.merge` stays as the common case. `String.trimStart` and `trimEnd`, by rules 2 and 3, text having `padStart` and `padEnd` already, shims as `trim` is for Unicode's whitespace. `Char.isAsciiDigit`, by rule 3: `Char.isDigit` is Unicode's digit class and stays, named for what it is, and what misled was a parser taking it and accepting digits `String.toInt` refuses; Rust makes the same split. `Terminal.columns(s)`, the columns a string takes at a terminal, an escape sequence none, a wide or emoji grapheme two, a grapheme only of combining or format characters none, by rule 3, in `Terminal` since the escape sequences are its, and used by the shell's region and the Markdown library, whose two copies go (items 8 and 23). OTP 29 has no public width function, only one inside `prim_tty`, an internal step 8 already flags, so by the `foreign` rule it is Ernest over a table built from Unicode's East Asian Width and emoji data, listed in `THIRD_PARTY_LICENSES`; a tab is the caller's, its width depending on its column. `Io.show(x)`, the text `Io.debug` prints, by rule 1, the runtime's printer with the compiler's descriptor, and pure. `Tcp.peer` and `Tcp.local`, a connection's two ends as an address in text and a port, by rules 1 and 2, `Left(Closed)` for a dead socket as `Tcp.port` has.

`Io.debug` is `Io.println(Io.show(x))` once `show` exists, a composition rule 4 would refuse if it came now. It stays, as a pair principle 2 allows the library, the first tool of debugging the guide teaches and what every example's `// =>` line is defined by; rule 4 now says a pair is named in its section, so the exception is stated rather than tacit. E.0's fifth shape rule said the modules over system references carry `with m`; it applies to what reaches the system reference, so `Terminal.columns` and `Io.show` are pure.
...
## The Path Rule Has One Owner, 2026-09-26

Feedback item 30. `:load`'s completion listed the source root a directory at a time and judged each entry with two functions of the shell's own, `isPathWord` and `capital`: §11.1's path shape and §4.2's path to namespace, written a second time beside the compiler's check in `ern_cli`. Two copies of one rule with nothing holding them equal drift, and completion would then offer a module `:load` refuses. Appendix E was refused, `Path.namespace` being the toolchain's layout rather than a general operation of a path (E.0 rule 3, principle 5); a copy held equal by a test is the restatement CLAUDE.md allows a list in code and a document, not two copies in code. Taken: the shell asks the compiler, which `:load` goes through anyway, what a name's segment is, `ern_shell:segment` over `ern_cli:segment`, the same function the path check uses, and lists the directory in Ernest as before. It is not one of the doors items 26 to 28 closed: those hid what a program might want, and this asks the toolchain the shell is built on about its own rule, as compiling an input does, which only the compiler answers without restating it.

## Completion Reaches What the Session Knows, 2026-09-26

Feedback item 54, the last of the fifth theme. With field selection (§3.5), `state.count` is an expression, and `state.` with `Tab` offered nothing, since §11.2's completion read what was before the last `.` as a namespace; a reader who has just learned field selection expects the fields, as `List.` offers the module's names (principle 1). What the shell knows at that point decided it. A name the session binds, `it` among them, has its type in the session's environment, and a module's exported value in the module's interface. A name the unfinished input binds, a parameter or a local `let`, has a type only once the input parses and checks, and running the checker over an incomplete parse is new machinery in the parser and the checker for one key (principle 5). Taken: after a name the session binds or a module exports, and a `.`, `Tab` completes the fields its type selects, those every constructor has, and follows a chain by the field's type; a name the input binds is not completed, and §11.2 says so, so the limit is stated rather than found.

## A Gate Before the Build, 2026-09-26

Steps 5 to 7 of MVP 2.65 decided some thirty questions in one day, each on its own and one at a time, and each argued as it came. Decisions made that way are each defensible and may together be more than the language needs: a function one decision added may be what a later one made unnecessary, and two may give two ways to do one job. Principle 5 is judged on the whole, not on a decision at a time, and principle 1 on what a reader meets, which is the sum. So before step 10 builds anything, a reader who took no part reads every log entry from *Names, Restarts and Supervision* to *Completion Reaches What the Session Knows* together, against principles 5 and 1 only, and reports what the decisions add and remove, counted, in the prelude, the standard library, the report and the toolchain; any two that overlap or give a second way; any a later one made unnecessary; and what could be dropped or merged, with what the language loses if it is. Each finding is decided with the user, one at a time, before the build. A reader who took no part reads best, as the sweeps have shown every time.

## A Failure of the Runtime Shows Its Stack, 2026-09-26

A question of MVP 2.65's step 8. A crash that is none of §7.4's causes became `Fault("error:badarg")`, the host's class and reason, and its stack was dropped, in `ern_rt:run/1` and at the foreign boundary alike; such a crash is almost always a defect of the toolchain or of a shim, and its report named no module and no line. The cause is a program's: `Down` carries it, and a stack is host detail that would change with every build and that a program could match on. Logging the stack where the crash happened would mix it into the program's output with nothing tying it to its fault, and a debug flag would be a second way to run a program (principle 2) that nobody knows to use before the defect they need it for. Taken: the stack travels beside the cause, in the exit reason, never in it. `Down` carries the text alone, and the report a person reads prints the stack beneath the fault line, for a failure in the runtime and a foreign function's raise only, since a §7.4 cause is the program's own and its text is complete. §7.3 names the text of a failure in the runtime, and §11.2 the stack beneath `ern`'s `fault:` line. The shell's fault lines take it with `FaultReport`, which gains a field `trace` for it in step 10, empty beneath a §7.4 cause.

## What a Name Resolved To Is Recorded, 2026-09-26

A question of MVP 2.65's step 8. The checker resolved a name under §4.2's lookup order and recorded its type but not the decision, so the emitter resolved it again in its own functions, `own_decl`, `is_prelude` and `is_value`, under a comment that said its order was the checker's; and for a name the session declared, the checker rewrote the name's path to the input that declared it, in a function that called that path an owner. Two copies of a rule drift, as the bitstring pattern the same day had shown, and §4.2's order, with the session's scope, the enclosing declaration's members and `Prelude.x` in it, is the rule whose drift would call a function other than the one checked, with nothing said. A resolver both stages called would still apply the rule twice. Taken: the name carries `ref`, the checker's answer, `var`, `{own, Owner, Name}`, `{remote, Ns, Owner, Name}` or `{prelude, QName}`, and the emitter reads it. The session's rewrite went with it, the path again meaning what the source wrote; the one analysis that had read an unqualified `spawn` as the prelude's, the reply check, reads the reference, which also stops it taking a module's own `spawn` for the prelude's.

## One Copy of Each Scope Rule, 2026-09-26

A question of MVP 2.65's step 8, after *What a Name Resolved To Is Recorded*. The checker and the emitter each carried three scope-aware walks: which top-level declarations an expression references, honouring the names bound inside it; what a pattern binds; and the names free in a local function's body. Two of the three recomputed in the emitter what the checker had decided, the order §8.5 evaluates the top-level lets in, under a comment that a disagreement would be a defect, and the third was the pattern walk whose two copies had both lost the bitstring clause. Taken: the checker records the initialization order where it checks the lets for cycles, and the emitter reads it, its `let_order`, `reached`, `refs`, `binds` and `binds_params` gone; what a pattern binds and the names free in an expression are one function each, in `ern_ast` beside the walk, beneath every stage, and the checker's capture check and the emitter's lifting each keep only the filter that is theirs. The checker's own `refs` stays, since it orders the definitions before any name is resolved and is the one copy of that rule.

## Where the Toolchain's Modules Split, 2026-09-26

A question of MVP 2.65's step 8: `ern_typecheck` at about three thousand lines, `ern_shell` and `ern_emitter` near eighteen hundred. A module earns a split where a part of it shares nothing with the rest, no private record threaded through and no mutual recursion; then a reader looking for a rule finds a module named for it. The cores are the opposite: the checker's inference and the emitter's expressions thread `#env` and `#cx` through a few hundred mutually recursive functions, and splitting them would expose the record, the checker's `-opaque` type with it, and follow one algorithm across files. They stay whole. Four parts shared nothing and moved: `ern_bitspec`, a segment's specifiers (§5.11), which the emitter was already reaching into the checker for; `ern_scope`, §5.4's rules for a local fn; `ern_docs`, the `Docs` chunk; and `ern_descriptor`, a type's descriptor, whose move removed a clause telling an environment from a context by the shape of its tuple. The checker is now about 2,800 lines and the emitter 1,330. The shell waits: its largest separable part is the process watcher, which step 10 deletes with its doors, and its `:browse` and `:doc` need its `#env`; it is measured again once the doors are gone.

## A Process Is Watched From Its Start, 2026-09-26

A question of MVP 2.65's step 8. §6.9 promised that the runtime remembers how every process it started ended, so that a `monitor` made after the end still got the cause, and the runtime kept a row for every process that had ever ended, until the program did: a server spawning a process per request, the idiom the guide teaches, grew it without bound, about 150 bytes a request. Remembering the last hundred thousand was weighed and refused as a fat bound every program pays for a case almost none meets; remembering for a few seconds, as putting a clock into what `monitor` answers (principle 3); remembering nothing, as Erlang does, was taken, a late `monitor` answering the new `Reason` `Unknown` with no spawn site, rather than a `Fault` that would lie about a process that returned (principle 5 pays one constructor, the one MVP 3.0 would have wanted for a lost peer).

Building it showed what the memory had been for. Every `monitor` in the repository's Ernest, the shell's, three examples' and the guide's five, and the test runner's own in Erlang, was a `spawn` followed by a `monitor`, and a process that ends at once wins that race almost every time; the REPL example would have printed `Unknown` for a fast division by zero. A spawn that is monitored from its start closes the race with no memory, Erlang's `spawn_monitor` beside its `noproc`: `spawnMonitored(w, f, wrap)` enters the prelude, its wait made in the reaper with the spawn, so its `Down` always carries the reason. Remembering an end for its spawner alone until it monitors, spawns again or ends was weighed, and refused for a rule a reader must learn, as was holding a spawned process until its spawner waits, which changes what `spawn` means. `monitor` stays, and has one job: watching a process one holds and did not start, an address received, a service binding, a socket, a supervisor watched by its child, each running when watched. The six sites became one call each, and the reply rule of §6.6 names `spawnMonitored`'s function argument beside `spawn`'s.

## The Shell Lets Go of an Input, 2026-09-26

MVP 2.65's step 8, after the table of ended processes, read the shell for the same kind of growth and measured it: 2,000 expressions such as `1 + i` grew the host's memory by 33.7 MB, about 17 KB and four atoms an input, which a long working session would hold for nothing. Three parts. The environment kept the compiled module of every input, where only one that declares needs it, for `:doc`, as its own comment said; that went (33.7 MB to 30.1). The module of an input that declares nothing, an expression or a `let`, stayed loaded after its answer; it is now deleted once the answer is in, unless what the input bound holds one of its functions, and purged unless a process the input spawned still runs it, each later input trying such a purge again (23.9 MB). The rest is the holder module each expression makes for `it`, its value and its interface, which the environment lengthens and copies at every input: a later input that declares may be bound to the `it` of its time (§11.2), so a holder can go only once nothing kept refers to it, which needs each input to record what earlier inputs it depends on. That is planned in step 10 with the shell's other changes, and the atoms that recycled input numbers would bound go to question 8 with the lexer's.

## An Input's Number Is Given Again, 2026-09-26

A question of MVP 2.65's step 8. The host never collects an atom, and a node dies at about a million. The lexer makes one for each distinct name it reads, harmless in a compiler run and bounded in a shell session by the names a person types; the shell made about four for each input, the names of its module and of the holder of what it binds, so that 2,000 expressions with no name in them made 8,350, and a session of about a quarter of a million inputs would end the node. Stating the bound in §11.2 would be a ceiling the language's own shell falls through; names as binaries through the front end would reach every stage for the smaller share, the emitter still needing atoms at the end. Taken: an input whose module was unloaded, which *The Shell Lets Go of an Input* made the case for every expression, gives its number to the next input, whose module is then named by atoms that exist; a module is unloaded only when nothing refers to it, so the reuse misleads nothing, and a kept input, the only kind whose name a person sees, never gives its number up. The holders of `it` count apart, since they are kept until step 10 frees them, and then give theirs up the same way. The lexer's atoms were weighed and kept, by principle 5: a rewrite of every stage for atoms that grow only with what a person types. What would change it is a program that compiles code it makes at run time, which peers in MVP 3.0 might make. The atoms the runtime makes are counted in MVP 2.7.

## A Function May Be Named `module_info`, 2026-09-26

A question of MVP 2.65's step 8. The host gives every BEAM module `module_info/0,1` and refuses a function named `record_info/2`, so `ernc` refused an Ernest function of either name with Erlang's own "function module_info/0 already defined", and at the prompt `let module_info = 1` faulted inside the shell; the report said nothing. Refusing the names in the checker, with a sentence in §2.3, would have added names the language forbids only because of one host (principle 5). Taken: the emitter compiles them as `'module_info$'` and `'record_info$'` at its one naming point, `$` being in no Ernest name, as the shell's input modules are `$Input<n>`; the runner's entry point, the shell's program and its holder of prompt bindings go through the same mapping, and the report says nothing, since nothing is refused and nothing seen.

## One Subscription to the Terminal a Process, 2026-09-26

A question of MVP 2.65's step 8. §8.2 said the terminal sends each subscriber every key, and was silent on a process that subscribes twice; the terminal process added the address at each call, so every key reached it once for each, and a subscriber that died was never removed, so the keys stayed a source that could deliver (§8.6) and a program left waiting on nothing was never found deadlocked. A subscription for each call, as each `monitor` call is its own message, would deliver a key twice, which no program wants of a stream; a fault on the second call would refuse a program that changes how its keys are wrapped when it changes mode. Taken: a process holds one subscription, a second replacing the first with its wrap, and a subscription ends when its process dies; §8.2 and E.16 say so, and the keys count as a source while someone would receive them.

## A Precondition Is One Line, 2026-09-26

A question of MVP 2.65's step 8: `Cond orelse fail(...)` in some twenty-five places. It is Erlang's way to state an assertion, and it reads as one; a helper that took the condition and the message would build every message, a formatted type among them, when the condition held, one that took a function for the message is noisier than the line it replaces, and a `case` at every site says nothing more in four lines. Two sites chained several conditions before the `fail`, where a reader had to count which failed; they became a `case`, and the style guide says that a precondition is one line and two or more conditions before a `fail` are a `case`.

## The Cold Read's Last Findings, 2026-09-26

MVP 2.65's step 9: the ten findings of the cold read that no theme took. Two had been answered by item 47: `send(Sys.stdout, ...)` (1.8), and a faulting `via` function aimed at a system process (the second half of 3.29), since a program can make no system message. Three hid defects, fixed at once. A `monitor` wrap that faulted killed the runtime's reaper, after which every `spawn` waited for ever, and an alarm's function that never finished froze the clock for every process; a wrap is now applied as `via`'s function is, by the delivery, its fault the fault of the process it delivers to, and in a process of its own counted as a source until it delivers, so that none holds up another; the terminal, whose keys must stay in order, applies its subscribers' wraps itself, a wrap that does not finish delaying only that subscriber's keys. `kill(Sys.stdout)` lost every line of output, those sent before it among them, and `kill` on a system process now faults the caller: a socket is no system reference and stays killable (E.18).
...
## One Way to Fault, 2026-09-26

The gate of MVP 2.65's step 10, its finding G1. `fault : (String) -> a`, added for a supervisor that gives up, and `todo : (String) -> a` were one job under two names, differing by the prefix `todo: ` of the cause, a variant principle 2 refuses in the prelude. Every use of `todo` in the repository, `examples/template.ern` and the guide's §6.5, was a broken invariant rather than unfinished code, so the name had already been misleading its writers (principle 1). Gleam's `todo` earns its place as a keyword the compiler warns of; Ernest has no warnings, its diagnostics being errors, so here it would have had no job of its own. Moving `fault` into a library would have left a deliberate fault spelled as unfinished work. Taken: `todo` goes and `fault` stays; unfinished code writes `fault("todo: ...")`, the same text, as easy to find.

## One Question About a Process, 2026-09-26

The gate of MVP 2.65's step 10, its finding G9. *The Live Processes Are a Library Function* made `Process.site(p)` pure, a spawn site never changing, and *A Process Is Watched From Its Start* then made the runtime keep nothing of a process that has ended, so `site` had nothing to answer once `p` had died and had to become what `mailboxSize` and `state` were, `with m` and `Optional`. Three functions answering one kind of fact, about a live process or `None`, are one question asked three times, and three calls may describe three moments of a process that changes or ends between them, which misleads exactly where a snapshot is read, in debugging. Taken: `Process.info(p) : Optional(Process.Info) with m`, `Info(site : String, queued : Int, activity : Activity)` read by field selection (§3.5), and `Activity = Running | Receiving | Calling`, the names G15 asked for: `queued` for the messages waiting, `Receiving` for a wait in a `receive`, `Calling` for one on a call's answer, and `Info` named for what it is within its module (E.0 rule 7). One function and two types where there were three functions and a type (principle 5), and Erlang's `process_info` in shape (principle 1).

## Everything About a Process in Its Module, 2026-09-26
...
The gate of MVP 2.65's step 10, its finding G10. The `Supervisor` decided in step 5 learns that a child restarted from a notice the module's wrapper sends at every start, and `Process.faults`, decided after it, delivers the same event with the child's `Process` and `restarted`; the reader leaned towards the supervisor subscribing instead. It keeps its notice. A subscription to faults is global: each supervisor would receive every fault of the runtime, the other supervisors' children's among them, and discard nearly all, a cost that grows with supervisors times faults, which *Memory that no collection reclaims is a defect* asks to be argued rather than accepted; the notice is one message a restart, to the one supervisor that owns the child, and says the event a strategy acts on without a match of `Process` against the children. The notice is a library's private protocol, no part of the language, so principle 2 is not reached; `Process.faults` stays for diagnostics, a log and a status page. MVP 2.66 writes why into the `Supervisor`'s documentation.

## The Last Types Named, 2026-09-26
...
## The Report Pass of Step 10, 2026-09-26

MVP 2.65's step 10, its third sub-step: every decision of the ledger written into the report in one pass. Six places where the report was silent were decided in it.

A system reference could be exported from its module or kept private to it. Once its message type is the module's to make (*The System References Live in Their Modules*), an exported reference gives a program an address it can neither send to nor adapt, useful only for `monitor`, which watches a process that never ends, and for `kill`, which step 9 refused. Private is the smaller rule (principle 5): no program can name a system process, and `kill`'s refusal of one leaves §6.9 and §7.4, a rule about a case no program can reach. The message types follow: `Clock`'s, `Fs`'s, `Terminal`'s and `Io`'s appear in no exported signature and are private, and `Tcp`'s `ListenerMsg` and `SockMsg`, which the addresses of a listener and a socket carry, are exported abstract.

`restarting(limit, f)` answers a function, so it can be called anywhere and not only as a spawned process's root. Restricting it to `spawn`'s argument would need a type of its own or a syntactic rule (principles 4 and 5). Called elsewhere it retries `f` in the calling process without telling the caller why, and the fault is still reported to standard error (§11.2), so nothing is caught. The limit is counted in a sliding window: after `n` restarts within the last `t` milliseconds the next fault is not restarted, as OTP counts `intensity` over `period`.

`ern run`'s report of every fault took the shell's line, `Counter.worker:23 faulted: division by zero`, since two forms for one event would be two ways (principle 2); a fault after which the process restarts reads `faulted, restarted:` before the cause, which keeps the cause last and whole whatever it holds. The entry process's fault is one of every fault, in the same form, so `fault:` goes; a killed entry prints `killed`, as step 9 decided.

`ern test` must run its tests one at a time for a deadlock to be one test's (step 9): with every test running at once, no progress means no test can finish, and none is to blame. The order is the module's, as the tests are declared.

A line of standard input that is not UTF-8 is the fault of the process that asked for it, which is the reader step 9 named; its cause is `Fault("the standard input is not UTF-8")`, beside the existing fault for an input that cannot be read at all.
...
`Tcp`'s requests now wait with `callForever`, so a program waiting in `accept` or `read` is waiting on a listener or a socket, which are not system processes, and §8.6 counted only a system process's pending I/O: such a program would have been read as deadlocked. §8.6 now names the listener and the socket beside the system processes, and the runtime counts a request that waits on one as a source and reads their mailboxes as it reads a system process's, a request not yet taken being a message in flight. The count of sources had been one number, which a socket killed while a read waited would have left up for good, so that no deadlock after it would be found; sources are now counted against the process that holds them, a holder's row going when its count is 0 or when the process it is linked to learns that it ended. A process that will deliver, a worker or an alarm's delivery, is counted before it starts, so no answer comes before its count. Inside `tcp.ern` the socket's constructor for its near end could not be `Local`, which would have shadowed the prelude's `Local` in the module, its own example included; being private, the two are `FarEnd` and `NearEnd`.

`Terminal.subscribe` now answers whether it has keys, and the shell asks it rather than the host: where standard output has a size the reader, holding the terminal first, subscribes, and the session paints a region on `Right` and reads lines on `Left(NotATerminal)`, so the screen is chosen after the reader's answer rather than before. The colour the shell uses at a terminal follows from the same answer, the host being asked only for `NO_COLOR`. The terminal had applied each subscriber's wrap itself, one after the other, so a wrap that did not finish held up every subscriber's keys, where §8.2 says it delays only its own; each subscriber now has a courier that applies its wrap in order. A test ran a program waiting for keys with its standard input closed, to see that the end of input ends the subscription as a source; such an input now refuses the subscription, so the test gives the terminal's process keys that end instead. `snake.ern`, whose keys are its input, says that it needs a terminal and ends its game when it is refused.
...
The report has no word limit. The aim is a report in Wirth's register, short and clear: state the rule, no rationale, no restating, in plain sentences a first reader follows; a sentence that tells the reader nothing new goes, one that does stays whatever the count, and a rule compressed into a cryptic sentence is a wart as much as a restated one. The prose of sections 0 to 11, without code blocks, table rows, and heading lines, is counted after every pass and recorded here so that growth is visible, and a section that grows past 600 words is read for restating. Oberon's ten pages was the measure when the language part was six pages and 2,100 words, and 3,200 words with distribution and the toolchain; the report since gained the reply discipline, bitstrings, system references, code shipping, the standard library's rules, and a toolchain. After the paring of 2026-09-18 it was 7,635 words in 81 sections at a median of 76, the longest §6.6 at 548, under a limit of 8,000. The entry of 2026-09-18 that raised the limit to 8,500 had counted headings and table rows in, 8,341 where the method gives 7,758. On 2026-09-19 the user removed the limit: a cut made for the count alone had cost clarity, the signposts and the sentences that name a consequence, and a limit prices a sentence by its length rather than by what it says. After the consistency pass and the paring read-back of 2026-09-19 it is 8,838 words in 81 sections, the longest §6.6 at 663, the reply discipline with its examples. After MVP 2.5 and its closing sweep, 2026-09-20, it is 9,870 words in 81 sections at a median of 80. The growth is the milestone's own: the `Test` type and `ern --test`, based literals and digit separators, prefix `!`, no negative zero, `Sys.stderr`, the terminal's mode and `Escape`, the exit reason a host sees, the signal that ends a program, the documentation a compiled module carries, and what an adapted address is. Two sections are over 600 and were read for restating: §6.6 at 701 and §3.9 at 650. Each is long because it states many distinct rules, the reply discipline with its forms of consumption and effect polymorphism with the three inferred restrictions, and neither says anything twice. Before MVP 2.65's report pass, 2026-09-26, it was 15,431 words in 81 sections at a median of 94, the shell's §11.2 alone 2,579; after it, 16,458 at the same median. The pass added the service binding and `restarting`, the call that ends with its callee, every fault on standard error, the toolchain's subcommands, the shell's commands, and the system references moved into their modules, and took out the `Sys` values and their message types, `todo`, and `kill`'s case for a system process. Three sections are over 600 and were read for restating: §11.2 at 2,976, §3.9 at 971 and §6.6 at 859. The commands' lines for `:load` and `:reload` repeated the paragraph on loading and now point at it; the rest states a rule a sentence, the shell's §11.2 being long because the shell has many rules, not because it says one twice.
