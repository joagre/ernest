...
The report has no word limit. The aim is a report in Wirth's register, short: state the rule, no rationale, no restating; a sentence that tells the reader nothing new goes, and one that does stays whatever the count. The prose of sections 0 to 11, without code blocks, table rows, and heading lines, is counted after every pass and recorded here so that growth is visible, and a section that grows past 600 words is restating something. Oberon's ten pages was the measure when the language part was six pages and 2,100 words, and 3,200 words with distribution and the toolchain; the report since gained the reply discipline, bitstrings, system references, code shipping, the standard library's rules, and a toolchain. After the paring of 2026-09-18 it was 7,635 words in 81 sections at a median of 76, the longest §6.6 at 548, under a limit of 8,000. The entry of 2026-09-18 that raised the limit to 8,500 had counted headings and table rows in, 8,341 where the method gives 7,758. On 2026-09-19 the user removed the limit: a cut made for the count alone had cost clarity, the signposts and the sentences that name a consequence, and a limit prices a sentence by its length rather than by what it says. After the consistency pass of 2026-09-19 it is 8,071 words in 81 sections, the longest §6.6 at 557.
